...
tenantsRouter.get("/", permissionGuard(["tp.tenant.read"]), async (req, res) => {
...
tenantsRouter.post("/", permissionGuard(["tp.tenant.create"]), async (req, res) => {
...
tenantsRouter.post("/:id/users", permissionGuard(["tp.tenant.user.assign"]), async (req, res) => {
