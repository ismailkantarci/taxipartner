// Lightweight JSON value representation for payload fields that accept arbitrary JSON.
...
export type TenantListSort = 'created' | 'name' | 'status' | 'tenantid';
...
export type TenantListResponse = ApiListResponse<TenantItem>;

export interface TenantMutateResponse extends ApiResponseBase {
  tenant?: TenantItem;
}

export type TenantRelatedListResponse<T> = ApiListResponse<T>;
